...
# # 启动夹爪服务
gnome-terminal --tab -- zsh -c "source ~/B_workspace/screw_dual_robot/devel/setup.zsh; roslaunch gripper_modbus Gripper_ModbusControl.launch type:=RGI port:=/dev/RPGI prefix:=RGI; exec zsh"
gnome-terminal --tab -- zsh -c "source ~/B_workspace/screw_dual_robot/devel/setup.zsh; roslaunch gripper_modbus Gripper_ModbusControl.launch type:=PGI port:=/dev/LPGI prefix:=PGI; exec zsh"
# 启动天平通信
...
# 启动A_gel_start
gnome-terminal --tab -- zsh -c "source ~/B_workspace/screw_dual_robot/devel/setup.zsh; roslaunch manipulator A_robot_start.launch; exec zsh"
sleep 20
